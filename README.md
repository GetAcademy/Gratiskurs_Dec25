...
- **Økt 1 — tirsdag 2.12 kl. 14:00–15:30**: Velkommen, installasjon (VS Code + Live Server), gjennomgang av HTML-skjelett med `canvas` og enkel tegning. Oppgaver og steg-for-steg: `Økt 1.md`.
- **Økt 2 — torsdag 4.12 kl. 14:00–15:30**: Variabler, operatorer, funksjoner med returverdi, enkle animasjoner og grunnleggende fysikk. Oppgaver og øvelser: `Økt 2.md`.
- **Økt 3 — tirsdag 9.12 kl. 14:00–15:30**: Grundig om `if`-setninger, logiske operatorer, tastastyring, gravitasjon og kollisjon. Start på enkel Flappy Bird. Oppgaver: `Økt 3.md`.
- **Økt 4 — torsdag 11.12 kl. 14:00–15:30**: Fullføre enkel Flappy Bird, spørsmål og svar, info om tilbud fra GET Academy. Oppgaver: `Økt 4.md`.

Se også:

- GitHub-repo med eksempelprosjekt: <https://github.com/GetAcademy/SimpleFlappyBirdWeb>
- Live-demo: <https://getacademy.github.io/SimpleFlappyBirdWeb/>
